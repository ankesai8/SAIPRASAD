...
const Services = () => {
  ...
  return (
    <section className="services section" id="services">
        <h2 className="section__title"style={{fontFamily:"changa"}}>Services</h2>
        <span className="section__subtitle"style={{fontFamily:"changa",fontSize:"1.25em"}}>What I Offer</span>
        ...
        <div className="services__container container grid">
            ...
            <div className="services__content">
                <div>
                    ...
                    <h3 className='services__title' style={{fontFamily:"changa"}}>
                        Frontend <br /> Development
                    </h3>
                </div>

                <span className="services__button" onClick={() => toggleTab(1)}style={{fontFamily:"changa"}}>View More
                ...
                <div className={toggleState === 1 ? "services__modal active-modal" : "services__modal"}>
                    <div className="services__modal-content">
                        ...
                        <h3 className='services__modal-title'style={{fontFamily:"changa"}}>Frontend Development</h3>
                        <p className='services__modal-description'style={{fontFamily:"changa"}}>
                        ...
                        <ul className="services__modal-services grid">
                            <li className="services__modal-service">
                                ...
                                <p className='services__modal-info'style={{fontFamily:"changa"}}>
                            ...
                            <li className="services__modal-service">
                                <i className='uil uil-check-circle services__modal-icon'style={{fontFamily:"changa"}}></i>
            ...
            <div className="services__content">
                ...
                <span className="services__button" onClick={() => toggleTab(2)}style={{fontFamily:"changa"}}>View More
                <i className='uil uil-arrow-right services__button-icon'></i></span>
                ...
                <div className={toggleState === 2 ? "services__modal active-modal" : "services__modal"}>
                    <div className="services__modal-content">
                        ...
                        <h3 className='services__modal-title'style={{fontFamily:"changa"}}>Backend Development</h3>
                        <p className='services__modal-description'style={{fontFamily:"changa"}}>
            ...
            <div className="services__content">
                ...
                <span className="services__button" onClick={() => toggleTab(3)}style={{fontFamily:"changa"}}>View More
                <i className='uil uil-arrow-right services__button-icon'></i></span>
